...
plt.plot(range(1, epochs + 1), epoch_train_accuracies, label='Train Accuracy', color='blue')
plt.plot(range(1, epochs + 1), epoch_test_accuracies, label='Test Accuracy', color='red')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
